...
var Store = function () {
    ...
    (0, _createClass3.default)(Store, [{
        key: 'exists',
        value: function () {
            var _ref6 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee8(key) {
                var exists, client, value;
                    ...
                    while (1) {
                        switch (_context8.prev = _context8.next) {
                            case 0:
                                ...
                                if (!(!key || !this.client || !this.client.exists)) {
                                    _context8.next = 4;
                                    break;
                                }
                            ...
                            case 11:
                                ...
                                debug('Error when trying invoke "exists" of redis driver:', _context8.t0);
                                _context8.next = 16;
        ...
        key: 'set',
        value: function () {
            var _ref7 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee9(key, value) {
                var storedValue;
        ...
        key: 'get',
        value: function () {
            var _ref8 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee11(key) {
                var client, value;
                    ...
                    while (1) {
                        switch (_context11.prev = _context11.next) {
                            case 0:
                                ...
                                if (!(!key || !this.client || !this.client.get)) {
                                    _context11.next = 3;
                                    break;
                                }
                            ...
                            case 6:
                                ...
                                return _context11.abrupt('return', JSON.parse(value));
...
var RedisStore = function (_Store) {
    ...
    function RedisStore(opts) {
        ...
        var _this = (0, _possibleConstructorReturn3.default)(this, (RedisStore.__proto__ || (0, _getPrototypeOf2.default)(RedisStore)).call(this, opts));
        ...
        var ttl = _this.ttl = redisOptions.ttl || expiresIn || EXPIRES_IN_SECONDS;

        //redis client for session
        _this.client = new _ioredis2.default(redisOptions);
