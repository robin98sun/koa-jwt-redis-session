...
describe('Testing jwt-redis-session', function () {
    ...
    it('Should authorise the token generated just now', (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee3() {
            ...
            while (1) {
                switch (_context3.prev = _context3.next) {
                    case 0:
                        ...
                        userObj = null;
                        _context3.next = 4;
                        return (0, _index.authoriseRequest)(ctxObj);
